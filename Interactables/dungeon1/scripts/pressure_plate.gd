...
@onready var audio_activate : AudioStream = preload("res://interactables/dungeon1/lever-01.wav")
@onready var audio_deactivate : AudioStream = preload("res://interactables/dungeon1/lever-02.wav")
